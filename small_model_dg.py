...
# C，G -> P
# source_train_dataset = C_dataset["train"] + G_dataset["train"]
# source_val_dataset = C_dataset["val"] + G_dataset["val"]
# target_dataset = P_dataset["test"]
# # C，P -> G
# source_train_dataset = C_dataset["train"] + P_dataset["train"]
# source_val_dataset = C_dataset["val"] + P_dataset["val"]
# target_dataset = G_dataset["test"]
#
# # G，P -> C
source_train_dataset = G_dataset["train"] + P_dataset["train"]
source_val_dataset = G_dataset["val"] + P_dataset["val"]
...
# Training loop
epochs = 8  # You may need to adjust the number of epochs
